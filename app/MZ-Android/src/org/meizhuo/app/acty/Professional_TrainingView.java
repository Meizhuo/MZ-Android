 ...
 * 
 */
public class Professional_TrainingView extends BaseActivity {
	...
	@Override protected void onCreate(Bundle savedInstanceState) {
		...
		tv_atricle_content
				.setText(Html
						.fromHtml("<p>　　广东省职业技能鉴定指导中心是广东省人力资源和社会保障厅直属事业单位。负责全省职业技能鉴定工作的组织、协调和指导，按照国家制定的职业技能鉴定规划、政策、标准和有关规定开展鉴定工作；组织编写地方职业标准，承担国家题库广东地方分库运行工作；开发鉴定题库及相关教材资料，"
